      ...
      */
      ...
      if(Robot.globalVariables.enableGyroDrive){
        if(Robot.globalVariables.calculatedZ > 0){
          Robot.oi.ltmotor.set(-Robot.globalVariables.calculatedZ);
          Robot.oi.rtmotor.set(-Robot.globalVariables.calculatedZ);
      ...
      if(Robot.oi.gamepad.getRawButton(RobotMap.buttonY)){
        Robot.oi.rtmotor2.setSelectedSensorPosition(0);
        Robot.oi.ltmotor.setSelectedSensorPosition(0);
        Robot.oi.gyro.reset();
      }
